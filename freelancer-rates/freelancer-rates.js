...
export function monthRate(ratePerHour, discount) {
  return applyDiscount(ratePerHour * WORK_HOURS_PER_DAY * BILLABLE_DAYS_PER_MONTH, discount);
}
...
export function daysInBudget(budget, ratePerHour, discount) {
  return Math.floor(budget / applyDiscount(ratePerHour * WORK_HOURS_PER_DAY, discount));
}
